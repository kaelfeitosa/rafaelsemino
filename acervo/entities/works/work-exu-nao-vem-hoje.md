...
year: 2022
attachments:
  - caption: Exu Não Vem Hoje, imagem 1
    role: documentation
    src: work-exu-nao-vem-hoje/work-exu-nao-vem-hoje-001.jpeg
    type: image
  - caption: Exu Não Vem Hoje, imagem 2
    role: documentation
    src: work-exu-nao-vem-hoje/work-exu-nao-vem-hoje-002.jpeg
    type: image
  - caption: Exu Não Vem Hoje, imagem 3
    role: documentation
    src: work-exu-nao-vem-hoje/work-exu-nao-vem-hoje-003.jpeg
    type: image
  - caption: Exu Não Vem Hoje, imagem 4
    role: documentation
    src: work-exu-nao-vem-hoje/work-exu-nao-vem-hoje-004.jpeg
    type: image
  - caption: Exu Não Vem Hoje, imagem 5
    role: documentation
    src: work-exu-nao-vem-hoje/work-exu-nao-vem-hoje-005.jpeg
    type: image
  - caption: Exu Não Vem Hoje, imagem 6
    role: documentation
    src: work-exu-nao-vem-hoje/work-exu-nao-vem-hoje-006.jpeg
    type: image
  - caption: Exu Não Vem Hoje, imagem 7
    role: documentation
    src: work-exu-nao-vem-hoje/work-exu-nao-vem-hoje-007.jpeg
    type: image
  - caption: Exu Não Vem Hoje, imagem 8
    role: documentation
    src: work-exu-nao-vem-hoje/work-exu-nao-vem-hoje-008.jpeg
    type: image
  - caption: Exu Não Vem Hoje, imagem 9
    role: documentation
    src: work-exu-nao-vem-hoje/work-exu-nao-vem-hoje-009.jpeg
    type: image
  - caption: Exu Não Vem Hoje, imagem 10
    role: documentation
    src: work-exu-nao-vem-hoje/work-exu-nao-vem-hoje-010.jpeg
    type: image
  - caption: Exu Não Vem Hoje, imagem 11
    role: documentation
    src: work-exu-nao-vem-hoje/work-exu-nao-vem-hoje-011.jpeg
    type: image
  - caption: Exu Não Vem Hoje, imagem 12
    role: documentation
    src: work-exu-nao-vem-hoje/work-exu-nao-vem-hoje-012.jpeg
    type: image
  - caption: Image
    role: documentation
...
occurrences:
  ...
  - title: Atuação e Co-fundação de Exu Não Vem Hoje
    ...
    attachments: []
---
Espetáculo teatral criado a partir do processo de pesquisa desenvolvido por Rafael Semino no Laboratório de Criação em Teatro da Escola Porto Iracema das Artes, em diálogo com sua investigação em torno de Exu, oralidade e presença cênica. A obra articula rito, jogo e participação do público, tendo Rafael Semino como autor e intérprete.
...
A gestação do projeto ocorreu no interior do Laboratório de Criação Cênica da Escola Porto Iracema das Artes (2022) e Laborátório de Pesquisa do CCBJ no bom jardim (2023). O processo criativo também pavimentou as bases técnicas periféricas do coletivo, integrando Felipe Marques na operação profunda de som e luz, configurando um ambiente teatral vivo e pulsante com Rafael Semino e Gabriel França atuando.
